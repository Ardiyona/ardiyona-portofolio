    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="editModalLabel">Edit Tech Stack</h4>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <i data-feather="x"></i>
                </button>
            </div>
            <form id="editTechStackForm" class="editTechStackForm"
                action="" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" name="code" value="" id="editTechStackCode"
                            class="form-control" required>
                        <span class="text-danger small" id="error-edit-code"></span>
                    </div>
                    <label>Nama: </label>
                    <div class="form-group">
                        <input type="text" name="name" value="" id="editTechStackName"
                            class="form-control" required>
